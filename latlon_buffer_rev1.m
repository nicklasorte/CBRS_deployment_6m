function [array_latlon_buffer]=latlon_buffer_rev1(app,array_latlon,buffer_radius_km)
...
for i=1:1:num_rows
    [buff_lat{i},buff_lon{i}]=scircle1(array_latlon(i,1),array_latlon(i,2),km2deg(buffer_radius_km),[],[],'degrees',50);
end
